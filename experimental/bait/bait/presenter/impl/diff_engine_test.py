...
class DummyGeneralTabManager:
    pass

class DummyPackageContentsManager:
    pass
...
def test_packages_tree_diff_engine():
    ...
    ptde = diff_engine.PackagesTreeDiffEngine(
        DummyGeneralTabManager(), DummyPackageContentsManager(), viewCommandQueue)

    ptde.apply_update((model.UpdateTypes.CHILDREN, model.NodeTypes.ROOT, 0, []))