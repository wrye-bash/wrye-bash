...
class FilterIds(enum.FlagEnum):
    __enumerables__ = (
        ...
        'CONFLICTS_INACTIVE', 'CONFLICTS_HIGHER', 'CONFLICTS_LOWER',
        'SELECTED_MATCHED', 'SELECTED_MISMATCHED',
        'SELECTED_OVERRIDDEN', 'SELECTED_MISSING',
        'UNSELECTED_MATCHED', 'UNSELECTED_MISMATCHED',
        'UNSELECTED_OVERRIDDEN', 'UNSELECTED_MISSING',
