...
class _BashIntermediaryProcess(_BashProcess):
    ...
    def run(self):
        ...
        app = bash.bashim.BashIntermediary(self.to_parent_queue, self.to_gui_queue, self.to_bashim_queue)
...
class _BashGUIProcess(_BashProcess):
    ...
    def run(self):
        ...
        import locale
        locale.setlocale(locale.LC_ALL, '')
        self._BashProcess__run(bash.gui.basher.main, self.to_parent_queue, self.to_gui_queue, self.to_bashim_queue)
