    ...
    Function PAGE_FINISH_Leave
        ...
        ${If} $0 == ${BST_CHECKED}
            ${If} $Path_OB != $Empty
                ...
                Delete "$Path_OB\Mopy\bash\db\*"
                Delete "$Path_OB\Mopy\bash\images\*"
                Delete "$Path_OB\Mopy\bash\l10n\*"
            ...
            ${If} $Path_Nehrim != $Empty
                ...
                Delete "$Path_Nehrim\Mopy\bash\db\*"
                Delete "$Path_Nehrim\Mopy\bash\images\*"
                Delete "$Path_Nehrim\Mopy\bash\l10n\*"
            ...
            ${If} $Path_Ex1 != $Empty
                ...
                Delete "$Path_Ex1\Mopy\bash\db\*"
                Delete "$Path_Ex1\Mopy\bash\images\*"
                Delete "$Path_Ex1\Mopy\bash\l10n\*"
            ...
            ${If} $Path_Ex2 != $Empty
                ...
                Delete "$Path_Ex2\Mopy\bash\db\*"
                Delete "$Path_Ex2\Mopy\bash\images\*"
                Delete "$Path_Ex2\Mopy\bash\l10n\*"
