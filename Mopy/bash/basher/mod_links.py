...
from ..cint import CBashApi, FormID ##: CBash should be in bosh
...
class Mod_Fids_Replace(OneItemLink):
    ...
    @staticmethod
    def _parser(): return CBash_FidReplacer() if CBashApi.Enabled else FidReplacer()
...
class Mod_ActorLevels_Export(_Mod_Export_Link):
    ...
    def _parser(self): return CBash_ActorLevels() if CBashApi.Enabled else ActorLevels()
...
class Mod_FactionRelations_Export(_Mod_Export_Link):
    ...
    def _parser(self):
        return CBash_FactionRelations() if CBashApi.Enabled else FactionRelations()
...
class Mod_Scripts_Export(_Mod_Export_Link):
    ...
    def _parser(self): return CBash_ScriptText() if CBashApi.Enabled else ScriptText()
...
class Mod_Stats_Export(_Mod_Export_Link):
    ...
    def _parser(self): return CBash_ItemStats() if CBashApi.Enabled else ItemStats()
...
class Mod_Prices_Export(_Mod_Export_Link):
    ...
    def _parser(self): return CBash_ItemPrices() if CBashApi.Enabled else ItemPrices()
...
class Mod_SigilStoneDetails_Export(_Mod_Export_Link):
    ...
    def _parser(self):
        return CBash_SigilStoneDetails() if CBashApi.Enabled else SigilStoneDetails()
...
class Mod_SpellRecords_Export(_Mod_Export_Link):
    ...
    def _parser(self):
        ...
        doDetailed = self._askYes(message, _(u'Export Spells'),
                                  questionIcon=True)
        return CBash_SpellRecords(detailed=doDetailed) if CBashApi.Enabled else \
...
class Mod_IngredientDetails_Export(_Mod_Export_Link):
    ...
    def _parser(self):
        return CBash_IngredientDetails() if CBashApi.Enabled else IngredientDetails()
...
class Mod_EditorIds_Export(_Mod_Export_Link):
    ...
    def _parser(self): return CBash_EditorIds() if CBashApi.Enabled else EditorIds()
...
class Mod_FullNames_Export(_Mod_Export_Link):
    ...
    def _parser(self): return CBash_FullNames() if CBashApi.Enabled else FullNames()
...
class _Mod_Import_Link_CBash(_Mod_Import_Link):
    def _enable(self):
        return super(_Mod_Import_Link_CBash, self)._enable() and CBashApi.Enabled
...
class Mod_ItemData_Export(_Mod_Export_Link): # CRUFT
    ...
    def _parser(self):
        return CBash_CompleteItemData() if CBashApi.Enabled else CompleteItemData()
