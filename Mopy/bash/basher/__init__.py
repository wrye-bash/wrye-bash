...
class ModPanel(SashPanel):
    def __init__(self,parent):
        ...
        left,right = self.left, self.right
        global modList
        from . import mods_links, mod_links
        mods_links.modList = mod_links.modList = modList = ModList(left)
        self.list = modList
...
class DocBrowser(wx.Frame):
    ...
    def __init__(self,modName=None):
        ...
        #--Singleton
        global docBrowser
        from . import mod_links
        mod_links.docBrowser = docBrowser = self
        #--Window
...
from .settings_links import * # needs to be below App_Button
#------------------------------------------------------------------------------
