...
from typing import (
    ...
    Mapping, MutableMapping, TextIO, overload, Protocol, TypeAlias, TypeVar,
)
...
class Tee:
    def __init__(self, stream_a: TextIO, stream_b: TextIO) -> None: ...
    def flush(self) -> None: ...
...
codebox: Callable[[Iterable[str], bool, bool], None] | None
