...
class FidReplacer(_HandleAliases):
    ...
    def __init__(self, types=None, aliases_=None):
        super(FidReplacer, self).__init__(aliases_)#--For aliasing mod names
...
class ItemStats(_HandleAliases):
    ...
    def __init__(self, types=None, aliases_=None):
        super(ItemStats, self).__init__(aliases_) #--For aliasing mod names
...
class SigilStoneDetails(_UsesEffectsMixin):
    ...
    def __init__(self, types=None, aliases_=None):
        super(SigilStoneDetails, self).__init__(aliases_) #--For aliasing mod names
        self.fid_stats = {}
...
class ItemPrices(_HandleAliases):
    ...
    def __init__(self, types=None, aliases_=None):
        super(ItemPrices, self).__init__(aliases_) #--For aliasing mod names
...
class SpellRecords(_UsesEffectsMixin):
    ...
    def __init__(self, types=None, aliases_=None, detailed=False):
        super(SpellRecords, self).__init__(aliases_) #--For aliasing mod names
        self.fid_stats = {}
...
class IngredientDetails(_UsesEffectsMixin):
    ...
    def __init__(self, types=None, aliases_=None):
        super(IngredientDetails, self).__init__(aliases_) #--For aliasing mod names
        self.fid_stats = {}
