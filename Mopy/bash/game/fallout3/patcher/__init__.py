...
graphicsTypes = {
    ...
    b'DOOR': (u'model',),
    b'EFSH': ('efsh_flags', 'particle_texture', 'fill_texture',
              'holes_texture', 'ms_source_blend_mode', 'ms_blend_operation',
              ...
              'edge_color_green', 'edge_color_blue', 'explosion_wind_speed',
              'texture_count_u', 'texture_count_v',
    ...
    b'IPCT': ('model', 'effect_duration', 'effect_orientation',
              ...
              'decal_parallax_scale', 'decal_parallax_passes', 'decal_flags',
              'decal_red', 'decal_green', 'decal_blue'),
    ...
    b'TXST': ('base_image_transparency_texture', 'normal_map_specular_texture',
              'environment_map_mask_texture', 'glow_map_texture',
              'parallax_map_texture', 'environment_map_texture',
              'decal_min_width', 'decal_max_width', 'decal_min_height',
              'decal_max_height', 'decal_depth', 'decal_shininess',
              'decal_parallax_scale', 'decal_parallax_passes', 'decal_flags',
              'decal_red', 'decal_green', 'decal_blue', 'txst_flags'),
...
actor_importer_attrs = {
    b'CREA': {
        'Actors.ACBS': ('barterGold', 'calcMax', 'calcMin', 'dispositionBase',
                        ...
                        'flags.noHead', 'flags.noKnockDown', 'flags.noLeftArm',
                        'flags.noLowLevel', 'flags.noRightArm',
                        ...
                        'flags.weaponAndShield', 'karma', 'speedMultiplier',
