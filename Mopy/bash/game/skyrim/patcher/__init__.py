...
graphicsTypes = {
    ...
    b'CONT': (u'model',),
    b'DOOR': (u'model',),
    b'EFSH': ('ms_source_blend_mode', 'ms_blend_operation',
              ...
              'ps_scale_key1_time', 'ps_scale_key2_time', 'color_key1_red',
              'color_key1_green', 'color_key1_blue', 'color_key2_red',
              'color_key2_green', 'color_key2_blue', 'color_key3_red',
              'color_key3_green', 'color_key3_blue', 'color_key1_alpha',
...
actor_importer_attrs = {
    b'NPC_': {
        'Actors.ACBS': ('bleedoutOverride', 'calcMax', 'calcMin',
                        'dispositionBase', 'flags.autoCalc',
                        'flags.bleedoutOverride', 'flags.doesNotAffectStealth',
                        'flags.doesNotBleed', 'flags.essential',
                        'flags.female', 'flags.invulnerable',
                        ...
                        'flags.summonable', 'flags.unique', 'healthOffset',
