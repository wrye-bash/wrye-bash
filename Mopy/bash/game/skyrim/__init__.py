...
class ASkyrimGameInfo(PatchGame):
    ...
    sounds_attrs = {
        ...
        b'SOPM': ('reverb_send_pct', 'sopm_type', 'ch0_fl', 'ch0_fr', 'ch0_c',
                  'ch0_lfe', 'ch0_rl', 'ch0_rr', 'ch0_sl', 'ch0_sr', 'ch1_fl',
                  'ch1_fr', 'ch1_c', 'ch1_lfe', 'ch1_rl', 'ch1_rr', 'ch1_sl',
                  'ch1_sr', 'ch2_fl', 'ch2_fr', 'ch2_c', 'ch2_lfe', 'ch2_rl',
                  'ch2_rr', 'ch2_sl', 'ch2_sr', 'av_min_distance',
                  'av_max_distance', 'av_curve1', 'av_curve2', 'av_curve3',
                  'av_curve4', 'av_curve5'),
