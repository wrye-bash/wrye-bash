    ...
    class MelLvlo(MelGroups):
        def __init__(self):
            MelGroups.__init__(self, u'entries',
                MelStruct(b'LVLO', [u'2H', u'I', u'2H'], u'level', (u'unknown1', null2),
...
class MreQust(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups('objectives',
            ...
            MelGroups('targets',
                MelStruct(b'QSTA', [u'i', u'B', u'3s'],'alias',(targetFlags,'flags'),('unused1',null3)),
                MelConditions(),
            ),
        ),
        ...
        MelGroups(u'qust_aliases',
            ...
            MelGroup('findMatchingReferenceFromEvent',
                MelStruct(b'ALFE', [u'4s'],('fromEvent',null4)),
                MelStruct(b'ALFD', [u'4s'],('eventData',null4)),
            ),
            MelConditions(),
            MelKeywords(),
            MelItemsCounter(),
...
class MreRefr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelTruncatedStruct(b'XLOC', [u'B', u'3s', u'I', u'B', u'3s', u'8s'], 'lockLevel', ('unused1',null3),
...
class MreSndr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelConditions(),
        MelStruct(b'LNAM', [u's', u'B', u's', u'B'],('unkSndr1',null1),'looping',
...
class MreSopm(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'ONAM', [u'24B'], u'ch0_l', u'ch0_r', u'ch0_c', u'ch0_lFE',
            ...
            u'ch2_bL', u'ch2_bR'),
        MelStruct(b'ANAM', [u'4s', u'2f', u'5B', u'3s'], (u'unknown2', null4), u'minDistance',
...
class MreWthr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'DATA', [u'B', u'2s', u'16B'],'windSpeed',('unknown',null2),'transDelta',
