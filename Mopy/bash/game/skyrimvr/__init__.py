...
"""This modules defines static data for use by bush, when TES V:
   Skyrim VR is set at the active game."""

from .constants import *
from ..skyrimse.default_tweaks import default_tweaks
from ... import brec
from ...brec import MreGlob
from ..skyrimse import SkyrimSEGameInfo

class SkyrimVRGameInfo(SkyrimSEGameInfo):
    # This has to have a lowercase r because of displayname logic in bush...
    ...
    vanilla_string_bsas = {
        ...
        u'skyrimvr.esm': [u'Skyrim - Patch.bsa', u'Skyrim - Interface.bsa', u'Skyrim_VR - Main.bsa'],
    }
