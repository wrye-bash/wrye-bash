...
class LoadOrder(object):
    ...
    def __getstate__(self): # we pickle _activeOrdered to avoid recreating it ##: plays with equals ??
    ...
    def __setstate__(self, dct):
        ...
        self.__mod_loIndex = dict((a, i) for i, a in enumerate(self._loadOrder))
        self.__mod_actIndex = dict(
            (a, i) for i, a in enumerate(self._activeOrdered))
