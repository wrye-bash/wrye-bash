...
def createLSCR(*args):
    ...
    parser.add_argument('-texturePath',
                        ...
                        dest='ddsPath',
                        help="Path to the 'Textures' folder containing the DDS textures for the Loading Screens.",
                        )
    parser.add_argument('-formids',
                        ...
                        dest='formidPath',
                        help='Path to the text file containing FormIDs of records to overwrite.',
                        )
    parser.add_argument('-descs',
                        ...
                        dest='descPath',
                        help='Path to the text file containing strings to be used as DESC subrecords.',
                        )
    parser.add_argument('-lnams',
                        ...
                        dest='lnamPath',
                        help='Path to the text file containing FormIDs to be added to each Loading Screen as a Direct LNAM subrecord.',
                        )
