...
attr_csv_struct = {
    ...
    'flags.disallowAbsorbReflect': [_str_to_bool,
                                    _('Disallow Absorb and Reflect')],
    'flags.ignoreLOS': [_str_to_bool, _('Area Effect Ignores LOS')],
    'flags.immuneToSilence': [_str_to_bool, _('Immune To Silence')],
    'flags.noAutoCalc': [_str_to_bool, _('Manual Cost')],
    'flags.scriptEffectAlwaysApplies': [_str_to_bool,
                                        _('Script Always Applies')],
    'flags.startSpell': [_str_to_bool, _('Start Spell')],
    'flags.touchExplodesWOTarget': [_str_to_bool,
