...
class InstallersData(DataStore):
    ...
    def irefresh(self, progress=None, what=u'DIONSC', fullRefresh=False,
            ...
            added_installers: _fnames = ()) -> RefrData:
        ...
        if 'I' in what:
            ...
            if refresh_info is None:
                if deleted or added_installers:
                    # if deleted or added we are passed existing installers
                    refresh_info = RefrData(set(deleted))
                    if added_installers: # call update_installers to update those
                        dirs_files = set(added_installers), ()
                    else:
        ...
        if u'N' in what or changes: changes |= self.refreshNorm() # todo does  this matter for refresh_info
        ...
        if u'C' in what or changes: # todo does the return value of refreshConverters matter for refresh_info??
    ...
    def move_infos(self, sources, destinations, window, bash_frame):
        ...
        self.irefresh(what='I', added_installers=moved)
        return moved
    ...
    def applyEmbeddedBCFs(self, installers=None, destArchives=None,
        ...
        self.irefresh(what='I', added_installers=dest_archives)
    ...
    def apply_converter(self, converter, destArchive, progress, msg,
        ...
        try:
            ...
            if dest_archives is not None: # caller must call irefresh on those!
                ...
                self.irefresh(what='I', added_installers=[destArchive])
                return iArchive
