...
magicEffects = {
    'ABAT': (5,_('Absorb Attribute')),
    'ABFA': (5,_('Absorb Fatigue')),
    'ABHE': (5,_('Absorb Health')),
    'ABSK': (5,_('Absorb Skill')),
    'ABSP': (5,_('Absorb Magicka')),
    'BA01': (1,_('Bound Armor Extra 01')),#--Formid == 0
    'BA02': (1,_('Bound Armor Extra 02')),#--Formid == 0
    'BA03': (1,_('Bound Armor Extra 03')),#--Formid == 0
    'BA04': (1,_('Bound Armor Extra 04')),#--Formid == 0
    'BA05': (1,_('Bound Armor Extra 05')),#--Formid == 0
    'BA06': (1,_('Bound Armor Extra 06')),#--Formid == 0
    'BA07': (1,_('Bound Armor Extra 07')),#--Formid == 0
    'BA08': (1,_('Bound Armor Extra 08')),#--Formid == 0
    'BA09': (1,_('Bound Armor Extra 09')),#--Formid == 0
    'BA10': (1,_('Bound Armor Extra 10')),#--Formid == 0
    'BABO': (1,_('Bound Boots')),
    'BACU': (1,_('Bound Cuirass')),
    'BAGA': (1,_('Bound Gauntlets')),
    'BAGR': (1,_('Bound Greaves')),
    'BAHE': (1,_('Bound Helmet')),
    'BASH': (1,_('Bound Shield')),
    'BRDN': (0,_('Burden')),
    'BW01': (1,_('Bound Order Weapon 1')),
    'BW02': (1,_('Bound Order Weapon 2')),
    'BW03': (1,_('Bound Order Weapon 3')),
    'BW04': (1,_('Bound Order Weapon 4')),
    'BW05': (1,_('Bound Order Weapon 5')),
    'BW06': (1,_('Bound Order Weapon 6')),
    'BW07': (1,_('Summon Staff of Sheogorath')),
    'BW08': (1,_('Bound Priest Dagger')),
    'BW09': (1,_('Bound Weapon Extra 09')),#--Formid == 0
    'BW10': (1,_('Bound Weapon Extra 10')),#--Formid == 0
    'BWAX': (1,_('Bound Axe')),
    'BWBO': (1,_('Bound Bow')),
    'BWDA': (1,_('Bound Dagger')),
    'BWMA': (1,_('Bound Mace')),
    'BWSW': (1,_('Bound Sword')),
    'CALM': (3,_('Calm')),
    'CHML': (3,_('Chameleon')),
    'CHRM': (3,_('Charm')),
    'COCR': (3,_('Command Creature')),
    'COHU': (3,_('Command Humanoid')),
    'CUDI': (5,_('Cure Disease')),
    'CUPA': (5,_('Cure Paralysis')),
    'CUPO': (5,_('Cure Poison')),
    'DARK': (3,_('DO NOT USE - Darkness')),
    'DEMO': (3,_('Demoralize')),
    'DGAT': (2,_('Damage Attribute')),
    'DGFA': (2,_('Damage Fatigue')),
    'DGHE': (2,_('Damage Health')),
    'DGSP': (2,_('Damage Magicka')),
    'DIAR': (2,_('Disintegrate Armor')),
    'DISE': (2,_('Disease Info')), #--Formid == 0
    'DIWE': (2,_('Disintegrate Weapon')),
    'DRAT': (2,_('Drain Attribute')),
    'DRFA': (2,_('Drain Fatigue')),
    'DRHE': (2,_('Drain Health')),
    'DRSK': (2,_('Drain Skill')),
    ...
    'FOFA': (5,_('Fortify Fatigue')),
    'FOHE': (5,_('Fortify Health')),
    'FOMM': (5,_('Fortify Magicka Multiplier')),
    'FOSK': (5,_('Fortify Skill')),
    'FOSP': (5,_('Fortify Magicka')),
    'FRDG': (2,_('Frost Damage')),
    'FRNZ': (3,_('Frenzy')),
    'FRSH': (0,_('Frost Shield')),
    'FTHR': (0,_('Feather')),
    'INVI': (3,_('Invisibility')),
    'LGHT': (3,_('Light')),
    'LISH': (0,_('Shock Shield')),
    'LOCK': (0,_('DO NOT USE - Lock')),
    'MYHL': (1,_('Summon Mythic Dawn Helm')),
    'MYTH': (1,_('Summon Mythic Dawn Armor')),
    'NEYE': (3,_('Night-Eye')),
    'OPEN': (0,_('Open')),
    'PARA': (3,_('Paralyze')),
    'POSN': (2,_('Poison Info')),
    'RALY': (3,_('Rally')),
    'REAN': (1,_('Reanimate')),
    'REAT': (5,_('Restore Attribute')),
    'REDG': (4,_('Reflect Damage')),
    'REFA': (5,_('Restore Fatigue')),
    'REHE': (5,_('Restore Health')),
    'RESP': (5,_('Restore Magicka')),
    'RFLC': (4,_('Reflect Spell')),
    'RSDI': (5,_('Resist Disease')),
    'RSFI': (5,_('Resist Fire')),
    'RSFR': (5,_('Resist Frost')),
    'RSMA': (5,_('Resist Magic')),
    'RSNW': (5,_('Resist Normal Weapons')),
    'RSPA': (5,_('Resist Paralysis')),
    'RSPO': (5,_('Resist Poison')),
    'RSSH': (5,_('Resist Shock')),
    'RSWD': (5,_('Resist Water Damage')), #--Formid == 0
    'SABS': (4,_('Spell Absorption')),
    'SEFF': (0,_('Script Effect')),
    'SHDG': (2,_('Shock Damage')),
    'SHLD': (0,_('Shield')),
    'SLNC': (3,_('Silence')),
    'STMA': (2,_('Stunted Magicka')),
    'STRP': (4,_('Soul Trap')),
    'SUDG': (2,_('Sun Damage')),
    'TELE': (4,_('Telekinesis')),
    'TURN': (1,_('Turn Undead')),
    'VAMP': (2,_('Vampirism')),
    'WABR': (0,_('Water Breathing')),
    'WAWA': (0,_('Water Walking')),
    'WKDI': (2,_('Weakness to Disease')),
    'WKFI': (2,_('Weakness to Fire')),
    'WKFR': (2,_('Weakness to Frost')),
    'WKMA': (2,_('Weakness to Magic')),
    'WKNW': (2,_('Weakness to Normal Weapons')),
    'WKPO': (2,_('Weakness to Poison')),
    'WKSH': (2,_('Weakness to Shock')),
    'Z001': (1,_('Summon Rufio\'s Ghost')),
    'Z002': (1,_('Summon Ancestor Guardian')),
    'Z003': (1,_('Summon Spiderling')),
    'Z004': (1,_('Summon Flesh Atronach')),
    'Z005': (1,_('Summon Bear')),
    'Z006': (1,_('Summon Gluttonous Hunger')),
    'Z007': (1,_('Summon Ravenous Hunger')),
    'Z008': (1,_('Summon Voracious Hunger')),
    'Z009': (1,_('Summon Dark Seducer')),
    'Z010': (1,_('Summon Golden Saint')),
    'Z011': (1,_('Wabba Summon')),
    'Z012': (1,_('Summon Decrepit Shambles')),
    'Z013': (1,_('Summon Shambles')),
    'Z014': (1,_('Summon Replete Shambles')),
    'Z015': (1,_('Summon Hunger')),
    'Z016': (1,_('Summon Mangled Flesh Atronach')),
    'Z017': (1,_('Summon Torn Flesh Atronach')),
    'Z018': (1,_('Summon Stitched Flesh Atronach')),
    'Z019': (1,_('Summon Sewn Flesh Atronach')),
    'Z020': (1,_('Extra Summon 20')),
    'ZCLA': (1,_('Summon Clannfear')),
    'ZDAE': (1,_('Summon Daedroth')),
    'ZDRE': (1,_('Summon Dremora')),
    'ZDRL': (1,_('Summon Dremora Lord')),
    'ZFIA': (1,_('Summon Flame Atronach')),
    'ZFRA': (1,_('Summon Frost Atronach')),
    'ZGHO': (1,_('Summon Ghost')),
    'ZHDZ': (1,_('Summon Headless Zombie')),
    'ZLIC': (1,_('Summon Lich')),
    'ZSCA': (1,_('Summon Scamp')),
    'ZSKA': (1,_('Summon Skeleton Guardian')),
    'ZSKC': (1,_('Summon Skeleton Champion')),
    'ZSKE': (1,_('Summon Skeleton')),
    'ZSKH': (1,_('Summon Skeleton Hero')),
    'ZSPD': (1,_('Summon Spider Daedra')),
    'ZSTA': (1,_('Summon Storm Atronach')),
    'ZWRA': (1,_('Summon Faded Wraith')),
    'ZWRL': (1,_('Summon Gloom Wraith')),
    'ZXIV': (1,_('Summon Xivilai')),
    'ZZOM': (1,_('Summon Zombie')),
    }
mgef_school = dict((x,y) for x,(y,z) in magicEffects.items())
mgef_name = dict((x,z) for x,(y,z) in magicEffects.items())
