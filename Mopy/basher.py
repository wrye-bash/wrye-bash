...
class ModDetails(wx.Window):
    ...
    def __init__(self,parent):
        ...
        self.cancel.Disable()
        #--Bash tags
        self.allTags = sorted(('Body-F', 'Body-M', 'C.Climate', 'C.Light', 'C.Owner', 'C.Water', 'Delev', 'Eyes', 'Factions', 'Relations', 'Filter', 'Graphics', 'Hair', 'IIM', 'Invent', 'Names', 'NoMerge', 'NpcFaces', 'R.Relations', 'Relev', 'Scripts', 'Sound', 'SpellStats', 'Stats', 'Voice-F', 'Voice-M','R.Teeth','R.Mouth','Roads'))
        #allTags = sorted(('R.BodyF', 'R.BodyM', 'C.Climate', 'C.Light', 'C.Owner', 'C.Water', 'L.Delev', 'R.Eyes', 'A.Factions', 'F.Relations', '+Filter', 'A.Graphics', 'R.Hair', '+IIM', 'A.Invent', 'A.Names', '+NoMerge', 'N.Faces', 'R.Relations', 'L.Relev', 'A.Sound', 'A.Stats', 'R.VoiceF', 'R.VoiceM','-Cells'))
...
class ModChecker(wx.Frame):
    ...
    def OnCopyText(self,event=None):
        ...
        text = '[codebox]'+self.text+'[/codebox]'
...
class App_Tes4Gecko(App_Button):
    ...
    def __init__(self,exePathArgs,image,tip):
        ...
        if GPath('bash.ini').exists():
            ...
            if bashIni.has_option('General','sTes4GeckoJavaArg'):
                self.javaArg = bashIni.get('General','sTes4GeckoJavaArg').strip()
...
def InitImages():
    ...
    #--Tools
    images['doc.on'] = Image(r'images/page_find.png',wx.BITMAP_TYPE_PNG)
    images['bashmon'] = Image(r'images/group_gear.png',wx.BITMAP_TYPE_PNG)
    images['modChecker'] = Image(r'images/table_error.png',wx.BITMAP_TYPE_PNG)
    #--ColorChecks
