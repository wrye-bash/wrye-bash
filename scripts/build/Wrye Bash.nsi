...
;-------------------------------- Finish Page
    ...
    Function PAGE_FINISH_Leave
        ...
        ${If} $0 == ${BST_CHECKED}
            ${If} $Path_OB != $Empty
                ExecShell "open" "$Path_OB\Mopy\Wrye Bash General Readme.html"
            ${ElseIf} $Path_Nehrim != $Empty
                ExecShell "open" "$Path_Nehrim\Mopy\Wrye Bash General Readme.html"
            ${ElseIf} $Path_Skyrim != $Empty
                ExecShell "open" "$Path_Skyrim\Mopy\Wrye Bash General Readme.html"
            ${ElseIf} $Path_Ex1 != $Empty
                ExecShell "open" "$Path_Ex1\Mopy\Wrye Bash General Readme.html"
            ${ElseIf} $Path_Ex2 != $Empty
                ExecShell "open" "$Path_Ex2\Mopy\Wrye Bash General Readme.html"
            ${EndIf}
        ${EndIf}
    ...
    Section "Uninstall"
        ...
        ${If} $CheckState_OB == ${BST_CHECKED}
            ${If} $Path_OB != $Empty
                ...
                Delete "$Path_OB\Mopy\bash\ScriptParsero.pyc"
        ...
        ${If} $CheckState_Nehrim == ${BST_CHECKED}
            ${If} $Path_Nehrim != $Empty
                ...
                Delete "$Path_Nehrim\Mopy\bash\ScriptParsero.pyc"
        ...
        ${If} $CheckState_Skyrim == ${BST_CHECKED}
            ${If} $Path_Skyrim != $Empty
                ...
                Delete "$Path_Skyrim\Mopy\bash\ScriptParsero.pyc"
                ...
                RMDir  "$Path_SkyrimMopy\Bash Patches"
